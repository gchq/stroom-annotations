...
docker build --tag gchq/stroom-annotations-service:latest stroom-annotations-svc/.
docker build --tag gchq/stroom-annotations-ui:latest stroom-annotations-ui/.